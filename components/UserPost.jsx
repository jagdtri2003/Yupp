    ...
    <View className="w-[88vw] mx-[6vw] my-6">
      <View className="flex flex-row justify-between items-center px-2 py-3">
        <View className="flex flex-row items-center space-x-3 rounded-full">
          ...
          />
          <View>
            <Text className="text-white font-pmedium">{toTitle(username)}</Text>
      ...
      <ActionSheet
        gestureEnabled={true}
        indicatorStyle={{ width: 100, backgroundColor: "#232323" }}
        id="example-sheet"
        ref={actionSheetRef}
      >
        ...
        {user.avatar === userImage && (
          <View className="w-full px-6 pt-4">
            <View className="flex flex-row items-center space-x-2">
              ...
              <Text className="text-red-500 text-[17px] font-pmedium pt-2">
                Delete this post{" "}
              </Text>
            </View>
          </View>
        ...
        <View className="w-full px-6 pt-4">
          <View className="flex flex-row items-center space-x-2">
            ...
            <Text className="text-black-500 text-[17px] font-pmedium pt-2">
              User's Profile{" "}
            </Text>
          </View>
        </View>
